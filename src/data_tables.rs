...
use crate::game::NORMAL_TABLE_SIZE;
...
pub static SYLLABLES: [&str; MAX_SYLLABLES] = [
...
// this table is used to generate a pseudo-normal distribution.  See the
// function random_number_normal_distribution() in game.rs, this is much faster
// than calling a transcendental function to calculate a true normal distribution.
static NORMAL_TABLE: [u16; NORMAL_TABLE_SIZE] = [
...
pub fn normal_table() -> &'static [u16; NORMAL_TABLE_SIZE] {
    &NORMAL_TABLE
}
