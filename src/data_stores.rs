...
use crate::store_data::{MAX_STORES, STORE_MAX_ITEM_TYPES};

// Buying and selling adjustments for character race VS store owner race
pub static RACE_GOLD_ADJUSTMENTS: [[u8; PLAYER_MAX_RACES]; PLAYER_MAX_RACES] = [
...
pub static STORE_CHOICES: [[u16; STORE_MAX_ITEM_TYPES]; MAX_STORES] = [
    // General Store
    [
